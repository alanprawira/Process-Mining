# -*- coding: utf-8 -*-
"""Data Understanding and preprocess.ipynb
...
# Convert the DataFrame (df_view) to a PM4Py EventLog object first
log_obj = log_converter.apply(df_view)

# Step 1: Remove cases without any endpoint activity
...
# Step 2: Keep only cases that have at least one of: A_Pending, A_Cancelled, A_Denied
...
# Discover classical Petri net
# Using pm4py.discover_petri_net_inductive for better compatibility
...
print(f"{'#'*10} Log W: Variants with 'W_Validate application' {'#'*10}\n")
